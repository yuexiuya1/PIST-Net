...
from .mobilevitTransformer import TransformerEncoder
from .mobilevitModelConfig import get_config 
...
class MobileViT(nn.Module):
    ...
    def __init__(self, model_cfg: Dict, num_classes: int = 1000):
        ...
        self.classifier.add_module(name="final_act", module=nn.Sigmoid())
