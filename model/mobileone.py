...
class MobileOne(nn.Module):
    ...
    def __init__(self,
        ...
        # Build stages
        self.stage0 = MobileOneBlock(in_channels=5, out_channels=self.in_planes,
        ...
        if with_class:
            self.outlayer.append(nn.Linear(int(512 * width_multipliers[3]), num_classes))
            self.outlayer.append(nn.Sigmoid())
...
def mobileone(num_classes: int = 1000, inference_mode: bool = False,
              variant: str = "s0", with_class: bool = True) -> nn.Module:
    """Get MobileOne model.
    ...
    return MobileOne(num_classes=num_classes, inference_mode=inference_mode,with_class=with_class,
                     **variant_params)
